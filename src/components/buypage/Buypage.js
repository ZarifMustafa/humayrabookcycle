...
function Buypage() {
  ...
  useEffect(() => {
    ...
    return () => {
      ...
      console.log('Book to find');
      console.log(bookToFind);
      console.log(JSON.stringify(bookToFind, null, 2));
    }
  }, [])
  ...
  <div className="frame-4">
    ...
    <div className="form-control-4">
      ...
      {bookToFind[0].copies[0].owner}
      
      </div>
      
  </div>
  <button className="buy-this-book-wrapper" type="submit" onClick={() => handleButtonClick('0')} >
  ...
  <div className="frame-13">
    <div className="form-control-4">{bookToFind[0].copies[0].selling_price}</div>
  </div>
  </>
          )}
</form>
